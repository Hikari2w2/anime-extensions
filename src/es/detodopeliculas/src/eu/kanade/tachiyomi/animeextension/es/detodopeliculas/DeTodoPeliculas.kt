...
// ============================ Video Links =============================
    override fun videoListParse(response: Response): List<Video> {
        ...
        return players.parallelCatchingFlatMapBlocking { player ->
            ...
            val url = getPlayerUrl(player, referer) ?: return@parallelCatchingFlatMapBlocking emptyList<Video>()
            extractVideos(url, lang, referer)
        }
    }

    private suspend fun extractVideos(url: String, lang: String, referer: String, depth: Int = 0): List<Video> {
